...
class HungarianMatcher(nn.Module):
    ...
    def memory_efficient_forward(self, outputs, targets, mask_type):
        ...
        for b in range(bs):
            ...
            # torch.save(cost_mask, '{}_cost_mask.pt'.format(random_text))
            # torch.save(cost_dice, '{}_cost_dice.pt'.format(random_text))
            ...
            after_linear_sum_assignment = linear_sum_assignment(C)
